...
namespace UdemyCourse_DesignPatternsInCSharpAndDotNET.BehavioralDesignPatterns._20Observer.WeakEventPattern
{
  ...
  public class Window2
  {
    ...
    {
            //reference For WindowsBase is available in dot net core
