...
namespace UdemyCourse_DesignPatternsInCSharpAndDotNET.BehavioralDesignPatterns._20Observer.ObserverInterfaces
{
    public class Event
    {
    ...
    public class ObserverInterfaces : IObserver<Event>
    {
        public static void Execute()
        {
            new ObserverInterfaces();
        }

        public ObserverInterfaces()
        {
