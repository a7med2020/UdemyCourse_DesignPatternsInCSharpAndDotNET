...
namespace UdemyCourse_DesignPatternsInCSharpAndDotNET.StructuralPatterns._10Facade.FacadeExercise
{
    ...
    public class FacadeExercise
    {
       static MagicSquareGenerator magicSquareGenerator = new MagicSquareGenerator();
        public static List<List<int>> Execute()
        {
            var square = magicSquareGenerator.Generate(3); // infinity loop
            return square;
        }
    }
}
