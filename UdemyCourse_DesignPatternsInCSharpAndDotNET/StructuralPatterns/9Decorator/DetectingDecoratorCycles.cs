...
namespace UdemyCourse_DesignPatternsInCSharpAndDotNET.StructuralPatterns._9Decorator.DetectingDecoratorCycles
{
    ...
    //{
    //    protected internal readonly List<Type> types = new List<Type>(); //new()
