...
namespace UdemyCourse_DesignPatternsInCSharpAndDotNET.CreationalPatterns._5Singleton.SingletonImplementation
{
    ...
    public class SingletonDatabase : IDatabase
    {
        ...
        private SingletonDatabase()
        {
            ...
            capitals = File.ReadAllLines(
              Path.Combine(
                new FileInfo(typeof(IDatabase).Assembly.Location).DirectoryName.Replace(@"\bin\Debug\netcoreapp3.1",""), "capitals.txt")
              )
              .Batch(2)
              .ToDictionary(
